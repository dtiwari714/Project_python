...
class Face_Recognition:
    ...
    def __init__(self,root):
        ...
        # first header image  
        # img=Image.open(r"Images_GUI\p9.jpg")
        ...
        # backgorund image 
        # bg1=Image.open(r"Images_GUI\p10.jpg")
        ...
        #title section
        title_lb1 = Label(text="Welcome to Face Recognition",font=("verdana",30,"bold"),bg="white",fg="navyblue")
        title_lb1.place(x=0,y=0,width=1366,height=45)

        # Create buttons below the section 
        # ------------------------------------------------------------------------------------------------------------------- 
        # Training button 1
        std_img_btn=Image.open(r"Images_GUI\p7.jpg")
    ...
    def face_recog(self):
        def draw_boundray(img,classifier,scaleFactor,minNeighbors,color,text,clf):
            ...
            for (x,y,w,h) in featuers:
                ...
                cursor.execute("select Roll_No from student where StudentID="+str(id))
                r=cursor.fetchone()
                r="+".join(r)
